...
class AdminKeranjangBelanjaViewModel @Inject constructor(
    ...
    private var _pesanan = MutableLiveData<UIState<ArrayList<ListKeranjangBelanjaModel>>>()
...
//    }
    ...
    fun getPesanan(): LiveData<UIState<ArrayList<ListKeranjangBelanjaModel>>> = _pesanan
