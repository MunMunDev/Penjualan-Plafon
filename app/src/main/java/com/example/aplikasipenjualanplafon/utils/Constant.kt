...
//    const val BASE_URL = "https://aplikasi-skripsi-um-parepare.000webhostapp.com/"
    const val BASE_URL = "https://aplikasi-tugas-kampus.my.id/"
    const val LOCATION_GAMBAR = "penjualan-plafon/gambar/"

    const val STORAGE_PERMISSION_CODE = 10

    const val MIDTRANS_SERVER_KEY = "\"SB-Mid-server-wA8kiwX70GwIoIOmlWkG5H-6\""
...
//    const val MIDTRANS_BASE_URL = "https://aplikasi-skripsi-um-parepare.000webhostapp.com/penjualan-plafon/api/response-midtrans.php//"
    const val MIDTRANS_BASE_URL = "https://aplikasi-tugas-kampus.my.id/penjualan-plafon/api/response-midtrans.php/"
