...
import com.example.aplikasipenjualanplafon.databinding.ListAdminPilihPlafonBinding
...
class AdminPilihPlafonAdapter(
    private val listPlafon: ArrayList<PlafonModel>,
    private val click: OnClickItem.ClickPlafon
): RecyclerView.Adapter<AdminPilihPlafonAdapter.ViewHolder>() {
    private val rupiah = KonversiRupiah()

    class ViewHolder(val binding: ListAdminPilihPlafonBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ListAdminPilihPlafonBinding.inflate(LayoutInflater.from(parent.context), parent, false)
